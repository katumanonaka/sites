...
<h2><?php echo __('Site'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($site['Site']['img_src']); ?>
			&nbsp;
                        <?phpimagegif(resource ($site['Site']['img_src'] ));?>
                        <?php
                            $id = $site['Site']['img_src'];
                            echo $this->Html->image("../upimg/{$id}", array('alt' => '画像がありません'));
                        ?>
<!--                        <img src="../../upimg/{<?php$site['Site']['img_src'];?>}.jpg">-->
		</dd>
...
<div class="related">
	...
	<?php foreach ($site['Category'] as $category): ?>
		<tr>
			<td><?php echo $category['id']; ?></td>
			<td><?php echo $category['cat_name']; ?></td>
			<td><?php echo $category['site_id']; ?></td>
